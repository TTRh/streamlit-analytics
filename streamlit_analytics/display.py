...
def show_results(counts, counts_for_each, reset_callback, unsafe_password=None):
    ...
    if show:
        ...
        st.header("Widget interactions (all)")
        st.markdown(
            """
        ...
        st.header("Widget interactions (for each run)")
        st.write(counts_for_each)
